    ...
    <div class="slider-row">
      ...
      <div class="track-viewport">
        <div class="track" id="team-track">
          <div class="team-item"><div class="team-photo"><img src="{{ asset('img/student2.png') }}" alt="PhD Researcher" loading="lazy" onerror="imgFallback(this)"><div class="placeholder" style="display:none;"><span>public/img/team-1.jpg</span></div></div></div>
          <div class="team-item"><div class="team-photo"><img src="{{ asset('img/student31.png') }}" alt="Graduate Research Assistant" loading="lazy" onerror="imgFallback(this)"><div class="placeholder" style="display:none;"><span>public/img/team-2.jpg</span></div></div></div>
          <div class="team-item"><div class="team-photo"><img src="{{ asset('img/test.png') }}" alt="Undergraduate Researcher" loading="lazy" onerror="imgFallback(this)"><div class="placeholder" style="display:none;"><span>public/img/team-3.jpg</span></div></div></div>
            <div class="team-item"><div class="team-photo"><img src="{{ asset('img/gra.jpeg') }}" alt="Undergraduate Researcher" loading="lazy" onerror="imgFallback(this)"><div class="placeholder" style="display:none;"><span>public/img/gra.jpg</span></div></div></div>
        </div>
      </div>
